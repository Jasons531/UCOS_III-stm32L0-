...
#define  APP_CFG_TASK_LED3_PRIO                           4u
...
#define  APP_CFG_TASK_LED2_STK_SIZE                      64u
#define  APP_CFG_TASK_LED3_STK_SIZE                      64u
...
#define  APP_CFG_TASK_LED1_STK_SIZE_PCT_FULL              90u
#define  APP_CFG_TASK_LED1_STK_SIZE_LIMIT        (APP_CFG_TASK_LED1_STK_SIZE      * (100u - APP_CFG_TASK_LED1_STK_SIZE_PCT_FULL))     / 100u

#define  APP_CFG_TASK_LED2_STK_SIZE_PCT_FULL              90u
#define  APP_CFG_TASK_LED2_STK_SIZE_LIMIT        (APP_CFG_TASK_LED2_STK_SIZE      * (100u - APP_CFG_TASK_LED2_STK_SIZE_PCT_FULL))     / 100u
